...
#  type_arr.push({:name=>'その他', :code=>'1998', :icon=>'http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=%e4%bb%96|000000|FFFFFF'})
  ...
  type_arr.push({:name=>'マンション', :code=>'1010', :icon=>'/assets/marker_yellow.png'})
  type_arr.push({:name=>'分譲マンション', :code=>'1015', :icon=>'/assets/marker_purple.png'})
  type_arr.push({:name=>'アパート', :code=>'1020', :icon=>'/assets/marker_blue.png'})
  type_arr.push({:name=>'一戸建貸家', :code=>'1025', :icon=>'/assets/marker_red.png'})
  type_arr.push({:name=>'テラスハウス', :code=>'1030', :icon=>'/assets/marker_orange.png'})
  type_arr.push({:name=>'メゾネット', :code=>'1035', :icon=>'/assets/marker_green.png'})
  type_arr.push({:name=>'店舗', :code=>'1040', :icon=>'/assets/marker_gray.png'})
  type_arr.push({:name=>'店舗付住宅', :code=>'1045', :icon=>'/assets/marker_gray.png'})
  type_arr.push({:name=>'事務所', :code=>'1050', :icon=>'/assets/marker_gray.png'})
  type_arr.push({:name=>'工場', :code=>'1055', :icon=>'/assets/marker_gray.png'})
  type_arr.push({:name=>'倉庫', :code=>'1060', :icon=>'/assets/marker_gray.png'})
  type_arr.push({:name=>'倉庫事務所', :code=>'1065', :icon=>'/assets/marker_gray.png'})
  type_arr.push({:name=>'工場倉庫', :code=>'1070', :icon=>'/assets/marker_gray.png'})
  type_arr.push({:name=>'定期借地権', :code=>'1085', :icon=>'/assets/marker_gray.png'})
  type_arr.push({:name=>'その他', :code=>'1998', :icon=>'/assets/marker_white.png'})
